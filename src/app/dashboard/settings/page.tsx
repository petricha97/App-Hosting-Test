...
export default function DashboardSettingsPage() {
  return (
    <div className="space-y-6">
      <DashboardPageHeader
        eyebrow="Settings"
        title="Keep the active workspace profile easy to understand."
        description="Settings stay intentionally light in v1. The page focuses on organization profile basics and creates room for future membership, permissions, and operational settings."
      />
