...
// per-source cursors). write:events-gated per spec T2 AC-9 ("All routes 403
// without write:events, 404 cross-org") via the shared registration route
// scope — deliberately stricter than the M3 responses list GET.
//
// Query params:
